          ...
          <div className={`rounded-xl border ${darkMode ? 'border-primary/40 bg-gray-900' : 'border-gray-300 bg-white'} p-4 mb-6`}>
            <div className="flex items-center gap-4">
              ...
              <select
                ...
                disabled={updating}
                className={`px-3 py-2 rounded-lg border ${darkMode ? 'bg-gray-800 border-gray-600 text-light' : 'bg-white border-gray-300 text-gray-800'} focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none`}
              >
                {STATUSES.map(s => (
